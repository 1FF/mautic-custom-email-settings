...
2. Clear the cache via console command `php bin/console cache:clear --env=prod` (might take a while) *OR* manually delete the `var/cache/prod` directory.
...
4. Run `php bin/console mautic:plugins:install` in the root Mautic directory.
